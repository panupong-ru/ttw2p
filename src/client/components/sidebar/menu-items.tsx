    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { text: 'ข้อมูลรถค้างชั่ง', icon: <Visibility />, href: ROUTE.MASTER_DATA.WAIT_WEIGHT },
          { text: 'ข้อมูลชั่งน้ำหนัก', icon: <Visibility />, href: ROUTE.MASTER_DATA.WEIGHT },
        ],
        isOpen: false,
      },
      // {
      ...
      // },
      {
        ...
        subItems: [
          ...
          // { text: 'ตั้งค่าเครื่องชั่ง', icon: <Visibility />, href: '' },
          {
            text: 'ตั้งค่าโปรแกรม',
            icon: <Visibility />,
            href: ROUTE.SYSTEM_MANAGEMENT.SETTINGS_PROGRAM,
          },
